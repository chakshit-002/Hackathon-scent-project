...
// const ProductCard = ({ productDet, index, cardClass = "" }) => {
//     const [isFavorited, setIsFavorited] = useState(() => {
//         const favorites = JSON.parse(localStorage.getItem("favorites")) || [];
//         return favorites.some(p => p.id === productDet.id);
//     });
//     useEffect(() => {
//         const favorites = JSON.parse(localStorage.getItem("favorites")) || [];
...
//                 <LensImage>
//                     <img src={imgLens} alt="zoomable image" className='max-[333px]:w-[200px] w-full h-full' />
//                 </LensImage>
//             </div>
