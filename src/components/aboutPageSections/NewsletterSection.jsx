...
const NewsletterSection = () => {
  ...
  return (
    // <section
    //   ref={containerRef}
    //   className="relative font-[cinzel] py-16 px-6 md:px-20 rounded-3xl shadow-lg flex items-center justify-center my-12 mx-auto w-full max-w-3xl xl:max-w-4xl 2xl:max-w-6xl overflow-hidden"
    //   style={{
    ...
    // >
    //   {/* Overlay */}
    //   <div className="absolute inset-0 bg-gradient-to-br bg-black/70 pointer-events-none rounded-3xl"></div>

    //   {/* Decorative perfume image, optional */}
    //   <div className="absolute top-4 left-0  pointer-events-none hidden md:block z-1">

    //     <img src={Newsletterimg1} className="w-30 h-30" />
    //   </div>
    ...
    //     <h2
    //       ref={headingRef}
    //       className="text-3xl md:text-4xl font-extrabold text-[#f8f7ec] text-center mb-2 leading-tight drop-shadow-lg"
    //     >
    //       Unlock Elegant Scents — Join Our Newsletter
    //     </h2>
    //     <p className="text-[#f8f7ec] text-center text-lg mb-4 max-w-md drop-shadow">
    ...
    //         type="email"
    //         autoComplete="email"
    //         className="flex-1 rounded-full px-5 py-3 outline-none focus:ring-2 focus:ring-[#db9b71]
    //           text-base text-[#492f44] bg-[#fff8fa] shadow border-none transition duration-150 ease-in-out"
    //         placeholder="Your email address"
    //       />
    //       <button
    //         ref={buttonRef}
    //         type="submit"
    //         className="inline-block rounded-full bg-[#cdf0ff] hover:bg-[#efedd7] transition cursor-pointer
    //           px-7 py-3 font-semibold text-[#181817] text-base shadow-lg focus:ring-4 focus:ring-[#db9b71] focus:outline-none"
    //       >
    //         Subscribe
    //       </button>
    //     </div> */}
    //     <div className="flex items-center w-full max-w-md rounded-full shadow bg-white">
    //       <input
    //         ref={inputRef}
    //         {...register("email", {
    //           required: "Email is required",
    ...
    //     )}
    //     <div className="mt-2 text-sm text-[#f8f7ec] opacity-95 text-center drop-shadow">
